...
describe('hack the future 2024', () => {
    it('first page', () => {
        ...
        cy.get(htf.infoBox).contains('Ok')
        cy.wait(10000)
        ...
        cy.get(htf.infoBox).should('be.visible')
        cy.get(htf.infoBox).contains('You managed to find the signal Wait...There is someone lying in the distance What is that yellow paper?')
        ...
        cy.get(htf.infoBox).should('be.visible')
        cy.get(htf.inputField).type('John Doe')
        cy.get(htf.inputButton).click()
        cy.get(htf.inputField).type('Earth')
        cy.get(htf.inputButton).click()
        cy.get(htf.yesButton).should('be.visible')
